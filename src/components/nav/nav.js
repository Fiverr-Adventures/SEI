            ...
            <div className="container-nav">
              ...
              <div className="nav-content">
                <div className="nav-item">
                  <a className="nav-link nav-bar-link nav_link-s" href="/Agenda">Agenda </a>
                  <a className="nav-link nav-bar-link nav_link-s" href="/Challenges">Challenges </a>
                </div>
                <div className="nav-item">
                  <a className="nav-link nav-bar-link nav_link-s" href="#">Hackathon </a>
                  <a className="nav-link nav-bar-link nav_link-s" href="/Speakers">Speakers </a>
                </div>
                  <div className="nav-item">
                    <a className="nav-link nav-bar-link nav_link-s" href="/Team">Team </a>
                    <a className="nav-link nav-bar-link lang" href="#"> EN <span className="pt">PT</span> </a>
                  </div>
              ...
              <div  className="menu-icon-wrapper" style={{visibility: 'visible',display: 'none'}}>
                ...
                <button  className="menu-icon-trigger" onClick={()=> handleClick()}></button>
              </div>
            </div>
        </nav>
      </div>

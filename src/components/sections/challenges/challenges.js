...
// import NavChallenge from '../components/utils/navChallenge';
...
function Challenges() {
    ...
    // }
    let challenge1 = (
        <Challenge title='Challenge Name 1'
    ...
    let challenge2 = (
        <Challenge title='Challenge Name 2'
            parag='Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur mattis erat in tellus porta, ut suscipit arcu iaculis. Sed tempor massa ipsum, et ornare dui dignissim vitae. Maecenas erat felis, laoreet sit amet felis quis, molestie pellentesque purus. Nam a euismod ante, a tincidunt elit.'
            buttonText=''
        />
    )
    let challenge3 = (
        <Challenge title='Challenge Name 3'
            parag='Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur mattis erat in tellus porta, ut suscipit arcu iaculis. Sed tempor massa ipsum, et ornare dui dignissim vitae. Maecenas erat felis, laoreet sit amet felis quis, molestie pellentesque purus. Nam a euismod ante, a tincidunt elit.'
            buttonText=''
        />
    )
    ...
    const NavChallenge = () => {
        ...
        return (
            <div className="navChallenge">
                <button className="title-nav"
                    onClick={() => changeStyle1(1)} style={{ paddingLeft: myStyle1.paddL }}
                >
                    <p className="meduim-5" style={{ color: myStyle1.clr }}>Challenge Name 1  </p>
                </button>
                <button className="title-nav"
                    onClick={() => changeStyle2(2)} style={{ paddingLeft: myStyle2.paddL, textColor: myStyle2.clr }}
                >
                    <p className="meduim-5" style={{ color: myStyle2.clr }} >Challenge Name 2 </p>
                </button>
                <div className="chall-three">
                    <button className="title-nav"
                        onClick={() => changeStyle3(3)} style={{ paddingLeft: myStyle3.paddL, textColor: myStyle3.clr }}
                    >
                        <p className="meduim-5" style={{ color: myStyle3.clr }} >Challenge Name 3</p>
                    </button>
                    <p className="x-small3 closed">Closed. See winners <a href="" className=" winner"> here</a></p>
                </div>

                <button className="title-nav"
                    onClick={() => changeStyle4(4)} style={{ paddingLeft: myStyle4.paddL, textColor: myStyle4.clr }}
                >
                    <p className="meduim-5" style={{ color: myStyle4.clr }} >CV Challenge</p>
                </button>
                <button className="title-nav"
                    onClick={() => changeStyle5(5)} style={{ paddingLeft: myStyle5.paddL, textColor: myStyle5.clr }}
                >
                    <p className="meduim-5" style={{ color: myStyle5.clr }} >Photo Challenge</p>
                </button>
                <button className="title-nav"
                    onClick={() => changeStyle6(6)} style={{ paddingLeft: myStyle6.paddL, textColor: myStyle6.clr }}
                >
                    <p className="meduim-5" style={{ color: myStyle6.clr }} >Final Challenge</p>
                </button>
            </div>
        );
    }
    ...
    useEffect(() => {
        if (data === 2)
            ...
            setchallenge(challenge3)
        else if (data === 4)
            setchallenge(challenge4)
        else if (data === 5)
            setchallenge(challenge5)
        else if (data === 6)
            setchallenge(challenge6)
    ...
    return (
        <>
            <div className="challenges" style={background}>
                <Container>
                    <NavBar />
                    <p className="x-large-1 chall-title">Challenges</p>
                    <div className="headerChallenge">
                        <h1 className="chall-desc">Participate in new challenges every
                    {' '}<span className="spanChall"> day
                        <div className="cardContainer">
                                    <Card img={HeaderIcon} alt="HeaderIcon" style={{ alignItems: 'flex-end' }}>You can also win awards every day. But that’s highly unlikely I would say...</Card>
                                </div>
                            </span>.
